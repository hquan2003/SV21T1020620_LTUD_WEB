...
namespace SV21T1020620.DataLayers.SQLServer
{
    public class ProductDAL : BaseDAL, IProductDAL<Product>
    {
        ...
        public int Count(string searchValue, int categoryID, int supplierID, decimal minPrice, decimal maxPrice)
        {
        ...
        public List<Product> List(int page, int pageSize, string searchValue, int categoryID, int supplierID, decimal minPrice, decimal maxPrice)
        {
